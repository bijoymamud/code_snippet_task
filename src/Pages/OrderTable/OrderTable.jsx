...
//       <div className='main_upper flex items-center  justify-end '>
//         <div className='w-full flex items-center gap-5'>
//           <h2 className=' text-xl font-extrabold '>Orders</h2>

//           <label className="input input-bordered w-3/6 flex items-center gap-2">
...
//         <div className='w-full flex items-center gap-3 img_div'>
